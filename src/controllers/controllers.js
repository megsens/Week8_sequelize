...
const updateaBookById = async (req, res) => {
    ...
    //   if book is not found in database
      if (!book) {
        ...
        // if the book is found successfully, the update the book and display the message and log the success message with the updated book  
      } else {
        const updateBook = await Book.findByIdAndUpdate(req.params.id, req.body, {
          new: true,
        });
        // after logging the new change successfully, display message and update the info in the book specific to the params.id that was requested and changed
        const successResponse = {
...
const deleteaBookByTitle = async (req, res) => {
    ...
    try {
      ...
      if (!book) {
        ...
        const newBook = await Book.deleteOne(filter);
        const successResponse = {
...
// these methods can be used to update or delete any part of the books database including the genre with slight adjustments.
